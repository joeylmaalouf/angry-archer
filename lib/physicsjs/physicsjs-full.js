...
(function(window){
    ...
    // Set tick rate for physics simulation in ticks per second
    function tickrate(ticks_per_second) {
        tick_interval = 1000/ticks_per_second; // Appropriate interval in ms
        return this;
    }
